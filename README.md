...
Проект реализует алгоритм Q-learning, в котором агент обучается находить оптимальный путь в сетке (grid environment), получая награды и штрафы за действия.
